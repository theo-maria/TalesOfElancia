...
/**
 * Une potion ayant 2 effets distincts
 */
public abstract class DoubleEffectPotion extends Potion {

    /**
     * Permet d'instancier une potion de double effet
     * @param NAME nom
     ...
     */
    public DoubleEffectPotion(String NAME, String DESCRIPTION, int BONUS_HEALTH, int BONUS_ARMOR, int BONUS_FORCE, int BONUS_AGILITY) {
